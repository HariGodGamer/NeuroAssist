        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            <button
              ...
              className="relative p-2 rounded-xl bg-white border border-[#E8E2DA] text-[#22201F] hover:bg-[#F7F1EC] transition-colors"
            >
            ...
            {showNotifications && (
              <div className="absolute right-0 mt-2 w-80 sm:w-96 bg-white border border-[#E8E2DA] rounded-2xl shadow-clinical-lg p-4 z-50 animate-slide-up">
                <div className="flex items-center justify-between pb-3 border-b border-[#F0EBE5]">
                  ...
                  <button onClick={() => setShowNotifications(false)} className="text-[#A39E98] hover:text-[#22201F]">
                ...
                <div className="divide-y divide-[#F7F1EC] max-h-72 overflow-y-auto mt-2">
                  {state.notifications.map((notif) => (
                    <div key={notif.id} className="py-2.5 flex items-start gap-3">
                      ...
                      <button onClick={() => dispatch({ type: 'DISMISS_NOTIFICATION', payload: notif.id })} className="text-[#A39E98] hover:text-[#7A1F2B] text-xs">
          ...
          <div className="flex items-center gap-2.5 pl-2 border-l border-[#E8E2DA]">
            ...
            <div className="hidden md:flex flex-col text-left">
              ...
              <button
                ...
                className="text-[10px] text-[#7A1F2B] font-medium leading-tight text-left hover:underline"
              >
                Sign Out
              </button>
            </div>
