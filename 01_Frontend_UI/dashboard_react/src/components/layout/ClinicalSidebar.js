...
import { FiGrid, FiUploadCloud, FiUsers, FiSliders, FiShield, FiLogOut } from 'react-icons/fi';
    ...
    <aside className="w-64 bg-[#FAF6F3] border-r border-[#E8E2DA] flex flex-col justify-between py-6 px-4 shrink-0 hidden lg:flex select-none">
      ...
      <div className="pt-4 border-t border-[#E8E2DA] space-y-2">
        <button
          ...
          className="w-full flex items-center gap-3 px-3.5 py-2 rounded-xl text-xs font-medium text-[#7A756F] hover:bg-[#F8EAED] hover:text-[#7A1F2B] transition-colors"
        >
